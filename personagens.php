                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="/guild/editar_personagem.php?nome=<?= $array['nome'] ?>">Editar</a></li>
                                    <li><a href="/guild/remover_personagem.php?nome=<?= $array['nome'] ?>">Remover</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
